...
class ProjectCodeRule(Base):
    ...
    - owner_id UNIQUE
    - prefix GLOBAL UNIQUE (iki bayi aynı prefix'i seçemez)
    ...
    owner_id       = Column(PGUUID(as_uuid=True), ForeignKey("app_user.id", ondelete="CASCADE"), nullable=False, unique=True, index=True)
